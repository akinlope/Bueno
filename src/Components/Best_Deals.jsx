...
const Bestdeals = ({ bestArr }) => {
  ...
  return (
    <Swiper spaceBetween={50} slidesPerView={"auto"}>
      {bestArr.map(({ id, order, save, pic, oldPrice, newPrice, discription, ttitle }) => {
        return (
          <SwiperSlide key={id}>
            <>
              <div className="mt-5 p-0 relative">
                <div className="rounded-xl shadow-3xl w-56 h-72 p-5 mb-4">
                  <div className="flex ">
                    ...
                    <div className="rounded-full w-16 h-16 justify-center absolute -top-5 right-0 bg-danger">
                  ...
                  <p className="text-sm text-priBlack mt-4">
                    {ttitle}
                  </p>
