...
const Navbar = ({ activeLink }) => {
  ...
  return (
    <motion.div>
      {/* fixed navbar after scrolling to a certain height (note: these elements are not necessary I'm just lazy :) */}
      {fixedNav && (
        <motion.nav
          className="px-4 md:px-6 lg:px-12 py-3 w-screen fixed shadow-3xl bg-pureWhite z-50 flex justify-between items-center"
        ...
        >
          ...
          <div className="flex items-center md:space-x-4 lg:space-x-6">
            ...
            <div className="relative bg-pureBlue p-2 lg:p-3 rounded-tr-lg rounded-tl-xl rounded-bl-2xl rounded-br-curve cursor-pointer">
              <MdOutlineShoppingCart className="text-pureWhite text-lg md:text-xl lg:text-2xl" />
